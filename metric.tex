...
Note that 
\[\mathfrak{C}_{F_1\cup\dots\cup F_n}\subset \mathfrak{C}_{F_1}\cap\dots\cap\mathfrak{C}_{F_n};\]
in particular finite interections of these sets are nonempty.

According to Tikhonov's theorem \cite[see][and the references there in]{chernoff}, $Y^X$ is compact.
