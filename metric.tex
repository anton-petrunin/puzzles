...
The latter is made in order to make it impossible to use the circles $c_i$ as a shortcut;
...
where $\triangle$ denote symmetric difference; that is, $A\triangle B=(A\setminus B)\cup (B\setminus A)$.
