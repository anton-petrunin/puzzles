...
will be denoted as 
\[|x-y|_X.\]
\item A metric space $X$ is called \index{length space}\emph{length space} if for any $\eps>0$ two points $x,y\in X$ can be connected by curve $\alpha$
such that
...
is called \index{horoabsolute}\emph{horoabsolute} of $X$.
