...
then existence of a map $M\to X$ that induce a surjective homomorphism $\pi_1 M\to \pi_1 X$ of their fundamental groups is a necessary and sufficient condition for existence of Gromov--Hausdorff approximation of $X$ by Riemannian metrics on $M$.
