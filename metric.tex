...
Note that this problem implies that the Lobachevsky plane admits an isometric embedding into $L^1$,
and using the construction above, one can do the same for the unit sphere.
The latter was observed by John Kelly \cite{kelly}.
