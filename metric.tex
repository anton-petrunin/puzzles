...
with 
\[\diam[f^{-1}\{k\}]<a\]
for any point %added the word point to avoid confusion with the combinatorial defninition of simplicial complex where k in K means k is a subsimplex.
$k\in K$.
...
$\mathbb{S}^2$ converging to the unit disc in the sense of Gromov--Hausdorff.
In fact, 
