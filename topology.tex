...
Note that if the surface has an empty boundary, then the answer is different:
...
An interesting twist to this idea was given by Dennis Sullivan [see \ncite{sullivan} and also 5.10 in \ncite{tukia-vaisala}].
...
The first proof was found Reinhard Börger \cite{borger}; see also note by Jeremy Brazas \cite{brazas}.
