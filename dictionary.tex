...
\item{\bf Energy functional.}\refstepcounter{thm}\label{Energy functional} Let $F$ be a smooth map from a closed Reiamnnian manifold $M$ to a Reiamnnian manifold $N$.
...
A complete metric space $X$ is called {\it length space}  if the distance between any pair of points in $X$ is equal to the infimum of lengths of curves connecting these points. 
...
\refstepcounter{thm}\label{Variation of turn} 
