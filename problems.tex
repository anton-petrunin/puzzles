...
\comment{It should be sufficient to know
...
%\begin{center}
\begin{lpic}[t(-11 mm),b(0 mm),r(0 mm),l(0 mm)]{pics/moon-in-puddle(1)}
%\lbl[b]{24,41;x}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
\right.
\] 
which $i\cdot \ZZ$-invariant; that is
...
Let $M$ be a complete connected non-negatively curved Riemannian manifold.
