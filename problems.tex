...
\comment{It shoukd be sufficient to know
definition of curvature of curve.
}
...
Assume $M$ is an oriented 3-dimensional Riemanninan manifold with positive scalar curvature 
...
To solve problem \ref{Bounded curvature}, one needs to know Novikov theorem on  the algorithmic unsolvability of the problem of recognition of the sphere $\mathbb S^m$ for
$m\ge 5$.
}
