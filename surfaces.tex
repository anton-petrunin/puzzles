...
We obtain 4 non-overlapping lenses in $\Sigma$ with diameter at most $\eps$.
...
This idea is due to Stephan Cohn-Vossen, \cite[see Satz 7 in][]{convossen};
generalizations were obtained by 
V??? Streltsov and Alexandr Alexandrov \cite[in][]{streltsov-alexandrov}
and by
Victor Bangert \cite[in][]{bangert}.
