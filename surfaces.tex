...
each connected component of $\Sigma\backslash \Pi$ is unbounded or contains points on the boundary of $\Sigma$.
...
We described a partial case of so called \index{monotonicity formula}\emph{monotonicity formula} for minimal surfaces.
...
Indeed, if the direction of $\gamma'$ is not asymptotic at some $t_0$
then $\gamma'(t\pm\eps)$ lies the interior of $K$ for some small $\eps>0$, a contradiction.
