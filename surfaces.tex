...
That is, if $t$ is the natural parameter, then total curvature of $\gamma$ equals to 
...
Actually, a geodesic as in the problem is a $C^{1,1}$ curve;
in particular the formula for total curvature mentioned above makes sense for such geodesic.
