...
\begin{pr}{}{Involute of  geodesic}\label{Involute of  geodesic}
...
Let us review couple of statements from \cite[][\S28]{hilbert-cohn-vossen}
about Gauss curvature which might help to solve the problem.
...
Actually, geodesics as in the problem are $C^{1,1}$-smooth;
...
Hence 
\[\int\limits_a^b |\gamma''(t)|\le 2\cdot\ell.\]
\qedsf
