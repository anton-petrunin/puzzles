...
A round gutter is a surface constructed the following way.
...
and the circle $\gamma$ will be called its bottom meridian.

\begin{pr}{\hard}{Gutter}\label{half-torus}
Let $\Omega\subset \RR^3$ is a round gutter with bottom meridian $\gamma$. 
