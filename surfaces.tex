...
then $|\phi(b)-\phi(a)|\z=2000\cdot\pi$.
\end{pr}
...
\[\ell'(t)=\kappa(t)
\ \ \text{and}\ \ 
\kappa'(t)\le C\cdot \ell(t)^4,\] 
where $C$ is a fixed constant;
it depends on the bound on forth derivative of Gauss curvature on the surface.
...
their proof is quite elementary.
