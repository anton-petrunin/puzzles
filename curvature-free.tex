...
For the Sasaki metric, we have the curve $v'(t)$ is perpendicular to the fiber $\T_{\gamma(t)}$ for any $t$.
\end{enumerate}
...
By Liouville's theorem, the same holds for $\gamma'(t)$
for any fixed $t$.
Therefore
the expected value of
\[\int\limits_0^1|df(\gamma'(t))|\cdot dt\]
is at most $\delta_m$.
