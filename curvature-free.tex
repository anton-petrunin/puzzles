...
Recall that a subset $K$ of Riemanninan manifold is called \index{convex set in Riemannian manifold}\emph{convex} if every minimizing geodesic connecting two  points in $K$ completely lies in $K$. 
...
\[\vol B_\eps(M)=\int\limits_M d_p\vol_m\cdot\int\limits_{B(0,r)_{\mathrm{N}_p}}J_V\cdot d_V\vol_{n-m},\leqno{({*})}\]
