...
The following problem states that for $\mathbb{S}^2$ such thing is not possible. 
...
Indeed, assume $p'=q$ for some $p,q\in\gamma$, then $|p-q|\ge 1$.
...
that divines the sphere into two disks $D$ and $D'$.
...
Let us indicate how to improve the bound from $\tfrac12$ to $1$.
