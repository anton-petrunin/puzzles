...
a more involved, but straightforward solution can be built on the fact that orthogonal projection of a convex figure can be covered by a the figure it self.
The latter statement is not as simple as one might think
it was conjectured by Viktor Zalgaller \cite{zalgaller-1971} and solved by Mikhail Kovalev \cite{kovalev};
a short proof of was found by G\'{e}za K\'{o}s and Jen\H{o} T\"{o}r\H{o}csik \cite{kos-toroscik}.
