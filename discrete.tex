...
these include finite-dimensional Alexandrov spaces with curvature bounded below.
...
To prove the lower bound, notice that $\binom{d+k-1}{d}$ is the dimension of the space of polynomials $p\:\RR^d\to\RR$ of total degree at most $k-1$.
