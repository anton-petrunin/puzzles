...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Space coloring}\label{Right-angled polyhedron}
...
and solved by Ludwig Danzer and Branko Grünbaum \cite{danzer-guenbaum}.
...
Therefore, if $A$ has less than $\binom{d+k-1}{d}$ points, then there is a nonzero polynomial $p$ of degree at most $k-1$ such that $A$ lies in its zero set $Z$.
