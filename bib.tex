...
\bib{panov-torus}{article}{
   author={Panov, Dmitri},
   title={Foliations with unbounded deviation on $\Bbb T^2$},
   journal={J. Mod. Dyn.},
   volume={3},
   date={2009},
   number={4},
...
\bib{tukia-vaisala}{article}{
   author={Tukia, Pekka},
   author={V{\"a}is{\"a}l{\"a}, Jussi},
   title={Bi-Lipschitz extensions of maps having quasiconformal extensions},
   journal={Math. Ann.},
   volume={269},
   date={1984},
   number={4},
   pages={561--572},
   %issn={0025-5831},
   %review={\MR{766014 (86c:30041)}},
   %doi={10.1007/BF01450765},
}
