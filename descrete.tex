...
\lbl[]{12,11;{\color{white} $W_0$}}
\lbl[]{8,18;{\color{white} $W_1$}}
\lbl[]{17,18;{\color{white} $W_2$}}
\lbl[]{20,11;{\color{white} $W_3$}}
\lbl[]{17,4;{\color{white} $W_4$}}
\lbl[]{8,4;{\color{white} $W_5$}}
\lbl[]{4,11;{\color{white} $W_6$}}
...
We say that $k$ is the kissing number of $W_0$ (briefly $k=\mathop{\rm kiss}W_0$)
