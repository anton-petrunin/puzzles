...
Then there is a line $\ell$ through $z$, 
...
Their applications overlap but aren't identical, the \emph{Vitali covering theorem} works for nice measures in arbitrary metric spaces while the \emph{Besikovitch covering theorem} work in nice metric spaces with arbitrary Borel measures.
