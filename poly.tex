...
it follows since the action is generated by rotations. 
...
Among 219 crystallographic actions, this is the only one that has the required property; see \cite{dunbar}.
...
In addition, these spaces have an isometric $\mathbb{S}^1$-action induced by the complex structure.
