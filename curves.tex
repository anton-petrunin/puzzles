...
In particular, $h(\delta)\to h$ as $\delta\to 0$ for some (possibly infinite) value $h$.
This value $h$ is called $\alpha$-dimensional Hausdorff measure of $X$ and denoted as $\mathcal{H}_\alpha(X)$.
