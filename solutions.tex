...
Without loss of generality we may assume that $\Sc_M\ge 1$.
...
Therefore condition $({*})$
means that we can push $\Sigma$ to one of its sides while nonincreasing its mean curvature in the first order.
...
denote by $\lambda$ its eigenvalue;
by $({*}{*})$,
$\lambda\ge 0$.

Prove that $f(x)>0$ at any $x$.
Since $Lf=\lambda f$, the inequalities $({*})$ follow.
...
\parit{Comments.}
The problem is is due to Mikhael Gromov and Blaine Lawson, see \cite{gromov-lawson}.
...
\begin{lpic}[t(-6mm),b(0mm),r(0mm),l(0mm)]{pics/spiral}
\end{lpic}
\end{wrapfigure}
...
%\begin{center}
\begin{lpic}[t(-0mm),b(-3mm),r(0mm),l(0mm)]{pics/fig8(1)}
%\lbl[b]{24,41;x}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
%\begin{center}
\begin{lpic}[t(-2mm),b(0mm),r(0mm),l(0mm)]{pics/milnors-discs()}
%\lbl[b]{24,41;x}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
%\begin{center}
\begin{lpic}[t(-6mm),b(0mm),r(0mm),l(0mm)]{pics/annuli()}
%\lbl[b]{24,41;x}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
A seuence of $\tfrac1n$-crooked maps can be constructed recurcevely. 
...
Construct recursevly a sequence of simple closed curves $\gamma_n\:[0,1]\to\RR^2$.
...
%\begin{center}
\begin{lpic}[t(-0mm),b(0mm),r(0mm),l(0mm)]{pics/circrooked(1)}
...
and for the right coice of the $\eps_n$ the set $D$ is bounded and its
bondary contains no simple curves.
...
(This example is called \emph{Whitehead manifold},
see \cite{whitehead}.)
\end{itemize}
For more advanced examples seach check Dogbone space and Casson handle.
...
\begin{wrapfigure}{o}{21mm}
\begin{lpic}[t(-0mm),b(-3mm),r(0mm),l(0mm)]{pics/tent}
\end{lpic}
\end{wrapfigure}
...
%\begin{center}
\begin{lpic}[t(-4mm),b(1mm),r(0mm),l(0mm)]{pics/Convex-triangulation(1)}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
A complex-analytic proof was found by Ivan Izmestiev, Robert Kusner, G{\"u}nter Rote, Boris Springborn and John Sullivan in \cite{izmestiev-rote-springborn-kusner}. 
