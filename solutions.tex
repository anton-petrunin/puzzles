...
Note that we can assume that $F$ is $T_0$;
...
Both results were proved by Michael McCord in \cite{mccord};
it is based on the construction given by Pavel Alexandrov in \cite{alexandrov-finite}.
