...
\lbl[b]{25,11;$\partial F$}
\lbl[l]{25,5,;{\small $T$}}
\lbl[tr]{6,24;{\small $z_0$}}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
%\begin{center}
\begin{lpic}[t(-4 mm),b(0 mm),r(0 mm),l(0 mm)]{pics/annuli()}
%\lbl[b]{24,41;x}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{o}{46 mm}
%\begin{center}
\begin{lpic}[t(-6 mm),b(0 mm),r(0 mm),l(0 mm)]{pics/Phi(1)}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
\begin{lpic}[t(-8 mm),b(-3 mm),r(0 mm),l(0 mm)]{pics/tent}
\end{lpic}
\end{wrapfigure}
...
\parit{Comment.} 
The inequality was originally proved by Axel Harnack by a different method,
see \cite{harnack}.
The idea of complexification is likely due to Felix Klein.
