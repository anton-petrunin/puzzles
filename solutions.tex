...
A solution via curve shortening flow was given by Konstantin Pankrashkin in  \cite{pankrashkin}.
...
\cite[Bing's house constructed in][will do]{bing}.
Similar constructions were given by Vladimir
Lagunov in \cite{lagunov-2}.

An similar argument shows that
