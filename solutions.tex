...
\begin{lpic}[t(-7 mm),b(2 mm),r(0 mm),l(0 mm)]{pics/birkhoff(1)}
...
\parit{Comments.} The pseudo-holomorphic curves (sometimes called \emph{gromomorphic curves}) 
...
%\begin{center}
\begin{lpic}[t(-3 mm),b(3 mm),r(0 mm),l(0 mm)]{pics/tripod}
%\lbl[b]{24,41;x}
\end{lpic}
%\end{center}
\end{wrapfigure}
...
To prove the second part of theorem, notice that if such metric would not exist, it would be an algorithm to recognize $\mathbb S^5$ among $5$-dimensional manifolds.
