...
\begin{itemize}
\item {\it Construct three disjointed non-empty open sets in $\RR$ which have the same boundary.}
...
\begin{itemize}
\item The integral curvature $\omega$ of $\Sigma$ can not exceed $2\cdot\pi$.
...
Ivanov, it is originated from a discussions with
...
\parit{Comments.}
This problem is a discussed in the lectures of Mikhael Gromov \cite[see][\S\textonehalf]{gromov-SGMC}.
...
\parit{Comments.} This proof was suggested nearly simultaneously by Steven Sivek and user damiano \cite[see][]{two-discs}.
...
if $i\ne j$.
The later implies that $\vol \UU M=\infty$,
a contradiction.
...
the involution $\iota$ above can not be made isometric \cite[see][]{gromov-filling}.
