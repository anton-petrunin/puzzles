...
\begin{pr}
Show that any smooth closed manifold admits an immersion with all normal curvatures less than $\sqrt{3}$ into the unit ball in a Euclidean space of sufficiently large dimension.
\end{pr}
