...
we assume the reader is familiar with the shape operator and the second fundamental form,
the Riccati and Jacobi equations,
comparison theorems,
and Morse theory.
...
of real dimension $4$.
Clearly, $m=\dim \Sigma\z=3$, but the degree of its volume growth is $4$.
...
\parbf{Convex lens.}
Before going into the proof, let us describe a straightforward idea that does not work.
