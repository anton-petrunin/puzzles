...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Curvature versus injectivity radius\thm}
\label{scalar-curv}
...
This problem is the geometric part of the isoperimetric inequality proved by Frederick Almgren \cite[see][]{almgren}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\parbf{Curvature versus  injectivity radius.}
We will show that 
