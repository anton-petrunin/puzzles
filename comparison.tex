...
Assume $M$ is a Riemannian manifold with boundary $\partial M$.
...
If $f$ is not smooth, then one can smooth it using Greene--Wu construction \cite[see Theorem~2 in][]{greene-wu} and repeat the above argument for the obtained function.
\qedsf

This estimate was used by Nina Lebedeva and the author \cite[see][]{lebedeva-petrunin-curvature}.
For classical applications of Bochner's formula including vanishing theorems and estimates for eigenvalues of Laplacian see \cite[II \S 8 in][]{lawson-michelsohn}.
